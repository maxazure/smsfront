...
class AppointmentList extends Component {
  columns = [
    ...
    { title: 'Appointment Date', dataIndex: 'appointment_date' },
    { title: 'Appointment When', dataIndex: 'appointment_when' },
  ...
  componentDidMount() {
    const { dispatch, appointment: { data: { pagination } } } = this.props;
    let params = {};
    if (pagination) {
      params = {
    ...
    dispatch({ type: 'appointment/fetch', payload: params });
  }
  ...
  render() {
    const {
      appointment: { data: { list, pagination } },
      loading,
    } = this.props;
      ...
      <PageHeaderWrapper>
        <Card bordered={false}>
          <div className={styles.tableListOperator}>
            <Button icon="plus" type="primary" onClick={() => router.push('/appointment/create')}>
              New Appointment
                    </Button>
          </div>
...
export default Form.create()(AppointmentList);
